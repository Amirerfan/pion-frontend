...
import { calculateGasMargin } from '../../utils/calculateGasMargin.ts';
...
export default function useBonPIONTransaction(
  ...
  return useMemo(() => {
    ...
    return {
      callback: async function onDibs(): Promise<TransactionResponse> {
              ...
              .catch((gasError) => {
                ...
                return provider
                  ...
                  .catch((callError) => {
                    ...
                    return {
                      call,
                      error: callError.reason ?? callError.message ?? 'Error',
                    };
                  });
              });
          }),
        ...
        let bestCallOption: SuccessfulCall | CallEstimate | undefined =
          estimatedCalls.find(
        ...
        if (!bestCallOption) {
          ...
          if (!firstNoErrorCall)
            throw new Error(
              `Unexpected error. Could not estimate gas for the transaction.`,
            );
